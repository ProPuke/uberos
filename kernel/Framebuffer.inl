...
inline void Framebuffer::set(U32 x, U32 y, U32 colour, U32 length) {
	...
	switch((int)buffer.format<<1|(int)buffer.order){ //the switch is faster ¯\_(ツ)_/¯
		...
		case (int)graphics2d::BufferFormat::grey8 <<1|(int)graphics2d::BufferFormatOrder::bgr: return set_grey8(x, y, colour, length);
		case (int)graphics2d::BufferFormat::rgb565<<1|(int)graphics2d::BufferFormatOrder::rgb: return set_rgb565(x, y, colour, length);
		case (int)graphics2d::BufferFormat::rgb565<<1|(int)graphics2d::BufferFormatOrder::bgr: return set_bgr565(x, y, colour, length);
		case (int)graphics2d::BufferFormat::rgb8  <<1|(int)graphics2d::BufferFormatOrder::rgb: return set_rgb8(x, y, colour, length);
		case (int)graphics2d::BufferFormat::rgb8  <<1|(int)graphics2d::BufferFormatOrder::bgr: return set_bgr8(x, y, colour, length);
		case (int)graphics2d::BufferFormat::rgba8 <<1|(int)graphics2d::BufferFormatOrder::rgb: return set_rgba8(x, y, colour, length);
		case (int)graphics2d::BufferFormat::rgba8 <<1|(int)graphics2d::BufferFormatOrder::bgr: return set_bgra8(x, y, colour, length);
	}
}
