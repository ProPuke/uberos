		...
		namespace serial {
			...
			void init() {
					...
					{ //uart 0
						...
						mmio::write_address(mmio::Address::uart0_ibrd, 1);
						// // Fractional part register = (.627 * 64) + 0.5 = 40.6 = ~40.
						mmio::write_address(mmio::Address::uart0_fbrd, 40);
					...
					{ //uart 1
						...
						mmio::write_address(mmio::Address::uart1_mu_baud, baud_to_reg(115200));
