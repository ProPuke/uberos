...
namespace mmu {
	...
	void init_kernelMap() {
		...
		// void *peripheral_start = round_address_down((void*)mmio::Address::peripheral_base);
		// void *peripheral_end = round_address_up((void*)((U64)mmio::Address::peripheral_base+(U64)mmio::Address::peripheral_length));
		...
		// kernelMapping.add_mapping(video_end, peripheral_start, RegionType::memory);
