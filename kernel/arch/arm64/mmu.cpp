...
namespace mmu {
	namespace {
		...
		// 		case RegionType::test: return "test memory";
		// 	}
		// 	return "unknown";
		// }
		...
		[[maybe_unused]] const char *addressSize_to_string(AddressSize size){
			switch(size){
		...
		// 		block_kernelExecuteNever = false;
		// 		block_executeNever = false;
	...
	// 	// switch(featureRegister.paRange){
	// 	// 	case 0b000:
	// 	// 		addressSize = AddressSize::_4GB;
	// 	// 	break;
	// 	// 	case 0b001:
	// 	// 		addressSize = AddressSize::_64GB;
	// 	// 	break;
	// 	// 	case 0b010:
	// 	// 		addressSize = AddressSize::_1TB;
	// 	// 	break;
	// 	// 	case 0b011:
	// 	// 		addressSize = AddressSize::_4TB;
	// 	// 	break;
	// 	// 	case 0b100:
	// 	// 		addressSize = AddressSize::_16TB;
	// 	// 	break;
	// 	// 	case 0b101:
	// 	// 		addressSize = AddressSize::_256TB;
	// 	// 	break;
	// 	// 	case 0b110:
	// 	// 		addressSize = AddressSize::_4PB;
	// 	// 	break;
	// 	// }
	...
	// 		mair_el1.entry[0] = 0b11111111; //"normal" memory
	// 		mair_el1.entry[1] = 0b00000000; //Device-nGnRnE memory (device memory, no-cache, write only)
	// 		mair_el1.entry[2] = 0b00000100; //Device-nGnRE memory (device memory, no-cache, no read or write)
	// 		mair_el1.entry[3] = 0b01000100; //"non-cache" test memory
	...
	// 		sctlr_el1.save_el1(); //FIXME: crash here
	// 	}
