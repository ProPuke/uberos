...
namespace driver {
	namespace textmode {
		...
		/**/ VgaTextmode:: VgaTextmode():
			Textmode("VGA Textmode", "Textmode display driver"),
			_address(0xb8000)
		{}

		/**/ VgaTextmode:: VgaTextmode(U64 address):
			Textmode("VGA Textmode", "Textmode display driver"),
			_address(address)
		{}

		auto VgaTextmode::_on_start() -> bool {
			if(!Super::_on_start()) return false;
		...
		auto VgaTextmode::_on_stop() -> bool {
			return true;
		}
