...
namespace ui2d {
	namespace theme {
		struct System8: Theme {
			...
			void draw_coloured_button(graphics2d::Buffer&, graphics2d::Rect, U32 backgroundColour, U32 colour, U8 opacity, const char *text, bool smallFont, graphics2d::MultisizeIcon icon, bool isHover, bool isDown) override;
			...
			void draw_titlebar_button(graphics2d::Buffer &buffer, graphics2d::Rect rect, U32 backgroundColour, U32 colour, U8 opacity, const char *text, bool smallFont, graphics2d::MultisizeIcon icon, bool isHover, bool isDown) override;
			void draw_titlebar_toggle_button(graphics2d::Buffer &buffer, graphics2d::Rect rect, U32 backgroundColour, U32 colour, U8 opacity, const char *text, bool smallFont, graphics2d::MultisizeIcon icon, bool toggleState, bool isHover, bool isDown) override;
			...
			auto get_window_titlebar_widget_minimise() -> graphics2d::MultisizeIcon& override;
			auto get_window_titlebar_widget_maximise() -> graphics2d::MultisizeIcon& override;
			auto get_window_titlebar_widget_close() -> graphics2d::MultisizeIcon& override;
			auto get_window_titlebar_widget_restore() -> graphics2d::MultisizeIcon& override;
